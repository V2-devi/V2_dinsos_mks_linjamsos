...
{isNotifOpen && (
  <div 
    ...
    onClick={(e) => {
        e.stopPropagation(); // Mencegah klik di sini menutup dropdown
    }}
  >
    ...
    <div className="notif-body">
      {notifData.map((n) => (
        <div 
          ...
          key={n.id} 
          onClick={(e) => {
            e.stopPropagation(); // Mencegah klik di sini tembus ke backdrop
            handleNotifClick(n); // Menjalankan fungsi navigasi
          }}
          style={n.isWelcome ? { 
