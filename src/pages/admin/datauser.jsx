...
import "./datauser.css";
// Path logo sudah disesuaikan dengan milik Anda
import logoLinjamsos from "../../assets/logo_linjamsos.png";

function DataUser({ goBack }) {
  // KUMPULAN STATE UNTUK SEMUA POP-UP
  ...
  // Fungsi saat tombol Simpan di Pop-up Edit ditekan
  const handleEditSubmit = (e) => {
    e.preventDefault();
    setIsEditModalOpen(false); // Tutup pop-up edit
    setIsSuccessModalOpen(true); // Buka pop-up sukses hijau
    
    // Otomatis tutup pop-up sukses setelah 3 detik
    setTimeout(() => {
              ...
              <form onSubmit={(e) => { e.preventDefault(); setIsAddModalOpen(false); }}>
                <div className="modal-section">
                  ...
                  <div className="form-grid-2">
                    <div className="form-group-modal"><label>NIK (Nomor Induk Kependudukan)*</label><input type="text" placeholder="16 digit angka" /></div>
                    <div className="form-group-modal"><label>Kata Sandi*</label><input type="password" placeholder="Minimal 8 Karakter" /></div>
                  </div>
                </div>
                <div className="modal-section">
                  <h3 className="section-subtitle">Data Pribadi Staff</h3>
                  <div className="form-grid-2">
                    <div className="form-group-modal"><label>Nama Lengkap (Sesuai KTP)*</label><input type="text" placeholder="Contoh: FIRLIANY FIRDAUS" /></div>
                    <div className="form-group-modal"><label>Email Aktif*</label><input type="email" placeholder="contohfirly@gmail.com" /></div>
                    <div className="form-group-modal"><label>Alamat*</label><input type="text" placeholder="Jln.nn" /></div>
                    <div className="form-group-modal"><label>No.HP*</label><input type="text" placeholder="+62xxxxxxxxxxxx" /></div>
                  </div>
                </div>
                <div className="modal-section">
                  ...
                  <div className="form-grid-2">
                    ...
                    <div className="form-group-modal">
                      ...
                      <div className="radio-group">
                        <label className="radio-label"><input type="radio" name="statusAkun" value="Aktif" defaultChecked /><span>Aktif</span></label>
                        <label className="radio-label"><input type="radio" name="statusAkun" value="Tidak Aktif" /><span>Tidak Aktif</span></label>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="modal-section">
                  ...
                  <div className="form-grid-2">
                    <div className="form-group-modal">
                      ...
                      <input type="text" placeholder="16 digit angka" defaultValue="09283197092980371" />
                    </div>
                    <div className="form-group-modal">
                      <label>Kata Sandi*</label>
                      <input type="password" placeholder="Minimal 8 Karakter" defaultValue="edwfdqde" />
                    </div>
                  </div>
                </div>
                <div className="modal-section">
                  ...
                  <div className="form-grid-2">
                    <div className="form-group-modal">
                      ...
                      <input type="text" placeholder="Contoh: FIRLIANY FIRDAUS" defaultValue="Devi Permata" />
                    </div>
                    <div className="form-group-modal">
                      <label>Email Aktif*</label>
                      <input type="email" placeholder="contohfirly@gmail.com" defaultValue="deviper@gmail.com" />
                    </div>
                    <div className="form-group-modal">
                      <label>NIP*</label>
                      <input type="text" placeholder="00000000000000" defaultValue="198012122005012001" />
                    </div>
                    <div className="form-group-modal">
                      <label>No.HP*</label>
                      <input type="text" placeholder="+62xxxxxxxxxxxx" defaultValue="089999999999" />
                    </div>
                    <div className="form-group-modal" style={{ gridColumn: "1 / -1" }}>
                      <label>Alamat*</label>
                      <input type="text" placeholder="Jln. nn" defaultValue="Gowa" />
                    </div>
                  </div>
                </div>
                <div className="modal-section">
                  ...
                  <div className="form-grid-2">
                    <div className="form-group-modal">
                      ...
                      <input type="text" placeholder="Dinas Sosial Kota Makassar" defaultValue="Dinas Sosial Kota Makassar" readOnly className="input-readonly" />
                    </div>
                    <div className="form-group-modal">
                      <label>Nama Kepala Dinas*</label>
                      <input type="text" placeholder="Xxxxxxxxxxxxxxxx" defaultValue="Andi Pangeran" />
                    </div>
                    <div className="form-group-modal">
                      <label>Alamat*</label>
                      <input type="text" placeholder="Dinas Sosial Kota Makassar" defaultValue="Jl. A.R. Hakim Makassar" />
                    </div>
                    <div className="form-group-modal">
                      <label>NIP*</label>
                      <input type="text" placeholder="00000000000000" defaultValue="197508082001121002" />
                    </div>
                  </div>
                </div>
                <div className="modal-actions">
          ...
          <div className="modal-content modal-small text-center" onClick={(e) => e.stopPropagation()}>
            <div className="modal-body" style={{ padding: '40px 20px 30px' }}>
              ...
              <div className="modal-actions">
                ...
                <button type="button" className="btn-modal-danger" onClick={() => { setIsDeleteModalOpen(false); /* Aksi hapus */ }}>Ya, Hapus</button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="modal-content modal-success" onClick={(e) => e.stopPropagation()}>
            <div className="modal-body text-center" style={{ padding: '40px 20px' }}>
              ...
              <p style={{ color: '#475569', fontSize: '13px', fontWeight: '500', margin: '0' }}>
                Data Anda Berhasil di Perhabarui
              </p>
            </div>
          </div>
        </div>
