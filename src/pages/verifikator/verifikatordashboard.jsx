...
function VerifikatorDashboard() {
  ...
  const notifData = [
    { id: 1, title: "Usulan Menunggu Validasi", date: "Hari ini", desc: "Terdapat 12 usulan Bansos baru dari Staf Pengisi Data (Kecamatan Tallo) yang menunggu persetujuan Anda." }
  ];
  ...
  // Handler Submit (Setuju / Tolak)
  const handleValidationAction = (e, actionType) => {
    e.preventDefault();
    ...
    <div className="verifikator-layout relative">
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-menu">
          ...
          <div className="menu-group">
            <button className={`menu-item ${activeMenu === "validasi_ppks" ? "active-group" : ""}`} onClick={() => setActiveMenu("validasi_ppks")}>
      ...
      <main className="main-content">
        ...
        {/* HEADER & NOTIFIKASI DROPDOWN (RAPI) */}
        ...
        <div className="content-body">
          ...
          {activeMenu === "dashboard" && (
            <div className="dashboard-verifikator-wrapper">
              ...
              {/* TUGAS MENUNGGU VALIDASI (TO-DO LIST) */}
              ...
              <div className="task-summary-grid">
                ...
                <div className="task-card ppks-task">
                  ...
                  <button className="task-card-btn" onClick={() => setActiveMenu("validasi_ppks")}>
                    Validasi Sekarang &rarr;
                  </button>
                </div>
              </div>

              {/* RINGKASAN EKSEKUTIF DTSEN */}
              ...
              {activeTab === "menunggu" && (
                <div className="outline-box">
                  <div className="alert-info-box warning" style={{ marginBottom: '25px', backgroundColor: '#fffbeb', border: '1px solid #fde047', borderRadius: '8px', padding: '16px', display: 'flex', gap: '15px' }}>
                    ...
                    <div>
                      <h4 style={{ margin: '0 0 5px 0', color: '#b45309', fontSize: '15px' }}>Tugas Validasi</h4>
          ...
          {/* ================= HALAMAN VALIDASI PPKS (KOSONG SEMENTARA) ================= */}
          {activeMenu === "validasi_ppks" && (
            <div className="outline-box" style={{ textAlign: 'center', padding: '100px 20px' }}>
              <h2 style={{ color: '#234a66' }}>Validasi Laporan PPKS</h2>
        ...
        <div className="modal-overlay" onClick={() => setIsValidateModalOpen(false)}>
          <div className="modal-content modal-large" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <form onSubmit={(e) => handleValidationAction(e, 'approve')} style={{ marginTop: '30px', borderTop: '2px solid #e2e8f0', paddingTop: '20px' }}>
                ...
                <div className="modal-actions" style={{ gap: '20px' }}>
                  <button type="button" className="btn-modal-danger" style={{ width: '100%', padding: '15px' }} onClick={(e) => handleValidationAction(e, 'reject')}>
                    Tolak & Kembalikan ke Staf
                  </button>
                  <button type="submit" className="btn-modal-submit" style={{ width: '100%', padding: '15px' }}>
                    Validasi & Setujui Data
                  </button>
                </div>
              </form>
            </div>
