                ...
                <tr key={user.id || Math.random()}>
                 ...
                 <td style={{ textAlign: 'center' }}>
                  ...
                  <td style={{ textAlign: "center" }}>                    
                    ...
                    {/* TOMBOL EDIT */}
                    <button onClick={() => navigate("/datauser")} className="btn-action-modern btn-edit-modern" title="Edit Pegawai">
                    ...
                    {/* TOMBOL HAPUS */}
                    <button onClick={() => navigate("/datauser")} className="btn-action-modern btn-delete-modern" title="Hapus Pegawai">
                      <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
