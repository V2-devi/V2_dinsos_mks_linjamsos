...
try:
    req = urllib.request.Request('https://backend-fastapi-ruby.vercel.app/keluarga/', data=json.dumps(data).encode('utf-8'), headers={'Content-Type': 'application/json'}, method='POST')
